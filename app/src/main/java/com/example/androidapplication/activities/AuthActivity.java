...
//import com.example.androidapplication.utils.DialogUtils; // Import lớp mới
...
//
//                    // Xử lý thành công
//                    // resource.data ở đây chắc chắn không null và là ApiResponse
//                    ApiResponse<InformationDTO> successResponse = resource.data;
...
//
//                    // Xử lý thất bại
//                    // resource.error ở đây chắc chắn không null và là ErrorResponse
//                    String errorMessage = resource.error.getErrorDetails().stream().map(it -> it.getMessage()).collect(Collectors.joining());
...
//
//
//    // Hàm tiện ích để quản lý trạng thái loading
//    private void setLoading(boolean isLoading) {
//        if (isLoading) {
//            binding.progressBar.setVisibility(View.VISIBLE);
//            binding.loginButton.setVisibility(View.INVISIBLE); // Ẩn nút Login đi
//        } else {
//            binding.progressBar.setVisibility(View.GONE);
//            binding.loginButton.setVisibility(View.VISIBLE); // Hiện lại nút Login
//        }
//    }
//}
